...
public class HrmCheckReadWrite {
	public static void main(String[] args) throws EncryptedDocumentException, IOException, InterruptedException {
		...
		Thread.sleep(3000);
		try {
			if(driver.findElement(By.xpath("//b[.='Dashboard']")).isDisplayed())
	        {
				flib.writeExcel("./data/OrangHrmdata.xlsx", "ValidData", 1, 2, "pass");
	        }
			
			}
			catch (Exception e) {
				flib.writeExcel("./data/OrangHrmdata.xlsx", "ValidData", 1, 2, "fail");
			}
